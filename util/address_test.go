	...
	tests := []struct {
		...
		// Positive P2PK tests.
		{
			...
			f: func() (util.Address, error) {
				publicKey := []byte{
					...
					0xe3, 0x4c, 0xce, 0x70, 0xc8, 0x63, 0x73, 0x27, 0x3e, 0xfc,
					0xe3, 0x4c}
				return util.NewAddressPublicKey(publicKey, util.Bech32PrefixOunce)
			},
			passedPrefix:   util.Bech32PrefixUnknown,
			expectedPrefix: util.Bech32PrefixOunce,
		},
		{
			name:    "mainnet p2pk 2",
			...
			passedPrefix:   util.Bech32PrefixOunce,
			expectedPrefix: util.Bech32PrefixOunce,
		},
		{
			name:    "testnet p2pk",
			...
			f: func() (util.Address, error) {
				...
				return util.NewAddressPublicKey(publicKey, util.Bech32PrefixOunceTest)
			},
			passedPrefix:   util.Bech32PrefixOunceTest,
			expectedPrefix: util.Bech32PrefixOunceTest,
		},
		...
		// ECDSA P2PK tests.
		{
			...
			f: func() (util.Address, error) {
				...
				return util.NewAddressPublicKeyECDSA(publicKey, util.Bech32PrefixOunce)
			},
			passedPrefix:   util.Bech32PrefixUnknown,
			expectedPrefix: util.Bech32PrefixOunce,
		},
		...
		// Positive P2SH tests.
		{
			...
			f: func() (util.Address, error) {
				script := []byte{
					...
					0xae}
				return util.NewAddressScriptHash(script, util.Bech32PrefixOunce)
			},
			passedPrefix:   util.Bech32PrefixOunce,
			expectedPrefix: util.Bech32PrefixOunce,
		},
		{
			...
			f: func() (util.Address, error) {
				...
				return util.NewAddressScriptHashFromHash(hash, util.Bech32PrefixOunce)
			},
			passedPrefix:   util.Bech32PrefixOunce,
			expectedPrefix: util.Bech32PrefixOunce,
		},
		{
			...
			f: func() (util.Address, error) {
				...
				return util.NewAddressScriptHashFromHash(hash, util.Bech32PrefixOunceTest)
			},
			passedPrefix:   util.Bech32PrefixOunceTest,
			expectedPrefix: util.Bech32PrefixOunceTest,
		},
...
func TestParsePrefix(t *testing.T) {
	tests := []struct {
		...
		{"kaspa", util.Bech32PrefixOunce, false},
		{"kaspatest", util.Bech32PrefixOunceTest, false},
		{"kaspasim", util.Bech32PrefixOunceSim, false},
...
func TestPrefixToString(t *testing.T) {
	tests := []struct {
		...
		{util.Bech32PrefixOunce, "kaspa"},
		{util.Bech32PrefixOunceTest, "kaspatest"},
		{util.Bech32PrefixOunceSim, "kaspasim"},
		{util.Bech32PrefixUnknown, ""},
	}
