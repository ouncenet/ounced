...
func generateTxs() (nativeTx, subnetworkTx *externalapi.DomainTransaction, err error) {
	...
	address1, err := util.DecodeAddress(address1Str, util.Bech32PrefixOunceSim)
	if err != nil {
	...
	address2, err := util.DecodeAddress(address2Str, util.Bech32PrefixOunceSim)
	if err != nil {
...
func getSourceScript(b *testing.B) *externalapi.ScriptPublicKey {
	...
	sourceAddress, err := util.DecodeAddress(sourceAddressStr, util.Bech32PrefixOunceSim)
	if err != nil {
