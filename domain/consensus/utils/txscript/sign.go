...
// SignatureScript creates an input signature script for tx to spend OZ sent
...
// SignatureScriptECDSA creates an input signature script for tx to spend OZ sent
