/*
Package txscript implements the ounce transaction script language.

This package provides data structures and functions to parse and execute
ounce transaction scripts.

# Script Overview

ounce transaction scripts are written in a stack-base, FORTH-like language.

The ounce script language consists of a number of opcodes which fall into
...
Typical ounce scripts at the time of this writing are of several standard
...
what conditions must be met in order to spend ounce.
