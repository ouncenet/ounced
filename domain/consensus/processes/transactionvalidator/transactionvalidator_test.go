...
func TestValidateTransactionInContextAndPopulateFee(t *testing.T) {
	testutils.ForAllNets(t, true, func(t *testing.T, consensusConfig *consensus.Config) {
		...
		tests := []struct {
			...
			{ // The total inputs amount is bigger than the allowed maximum (constants.MaxGrain)
			...
			{ // The total GrainIn (sum of inputs amount) is smaller than the total GrainOut (sum of outputs value) and hence invalid.
