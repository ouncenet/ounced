...
// Params defines a Ounce network by its parameters. These parameters may be
// used by Ounce applications to differentiate networks as well as addresses
...
// MainnetParams defines the network parameters for the main Ounce network.
...
// TestnetParams defines the network parameters for the test Ounce network.
var TestnetParams = Params{
	...
	// Human-readable part for Bech32 encoded addresses
	Prefix: util.Bech32PrefixOunceTest,
...
// SimnetParams defines the network parameters for the simulation test Ounce
...
var SimnetParams = Params{
	...
	// Human-readable part for Bech32 encoded addresses
	Prefix: util.Bech32PrefixOunceSim,
...
// DevnetParams defines the network parameters for the development Ounce network.
var DevnetParams = Params{
	...
	// Human-readable part for Bech32 encoded addresses
	Prefix: util.Bech32PrefixOunceDev,
...
// ErrDuplicateNet describes an error where the parameters for a Ounce
// network could not be set due to the network already being a standard
// network or previously-registered into this package.
var ErrDuplicateNet = errors.New("duplicate Ounce network")

var registeredNets = make(map[appmessage.OunceNet]struct{})

// Register registers the network parameters for a Ounce network. This may
