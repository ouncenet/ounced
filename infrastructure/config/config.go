...
const (
	...
	defaultMinRelayTxFee         = 1e-5 // 1 grain per byte
...
type Flags struct {
	...
	MinRelayTxFee                   float64       `long:"minrelaytxfee" description:"The minimum transaction fee in OZ/kB to be considered a non-zero fee."`
