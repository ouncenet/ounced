/*
Package addressmanager implements concurrency safe Ounce address manager.

# Address Manager Overview

In order maintain the peer-to-peer Ounce network, there needs to be a source
of addresses to connect to as nodes come and go. The Ounce protocol provides
