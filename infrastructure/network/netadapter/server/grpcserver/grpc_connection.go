...
type grpcStream interface {
	Send(*protowire.OuncedMessage) error
	Recv() (*protowire.OuncedMessage, error)
}
...
func (c *gRPCConnection) receive() (*protowire.OuncedMessage, error) {
...
func (c *gRPCConnection) send(message *protowire.OuncedMessage) error {
