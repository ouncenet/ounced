...
type GetBlockTemplateRequestMessage struct {
	...
	// Which ounce address should the coinbase block reward transaction pay into
...
type GetBlockTemplateResponseMessage struct {
	...
	// Whether ounced thinks that it's synced.
	// Callers are discouraged (but not forbidden) from solving blocks when ounced is not synced.
	// That is because when ounced isn't in sync with the rest of the network there's a high
...
type GetConnectedPeerInfoMessage struct {
	...
	// Whether this ounced initiated the connection
	...
	// The timestamp of when this peer connected to this ounced
