...
func (x *OuncedMessage_GetBlocksRequest) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "OuncedMessage_GetBlocksRequest is nil")
	}
	return x.GetBlocksRequest.toAppMessage()
}

func (x *OuncedMessage_GetBlocksRequest) fromAppMessage(message *appmessage.GetBlocksRequestMessage) error {
...
func (x *OuncedMessage_GetBlocksResponse) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "OuncedMessage_GetBlocksResponse is nil")
	}
	return x.GetBlocksResponse.toAppMessage()
}

func (x *OuncedMessage_GetBlocksResponse) fromAppMessage(message *appmessage.GetBlocksResponseMessage) error {
	var err *RPCError
