...
func (x *OuncedMessage_Addresses) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrap(errorNil, "OuncedMessage_Addresses is nil")
	}
...
func (x *OuncedMessage_Addresses) fromAppMessage(msgAddresses *appmessage.MsgAddresses) error {
