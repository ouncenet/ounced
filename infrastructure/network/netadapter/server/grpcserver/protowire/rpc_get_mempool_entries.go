...
func (x *OuncedMessage_GetMempoolEntriesRequest) toAppMessage() (appmessage.Message, error) {
	if x == nil {
...
func (x *OuncedMessage_GetMempoolEntriesRequest) fromAppMessage(message *appmessage.GetMempoolEntriesRequestMessage) error {
...
func (x *OuncedMessage_GetMempoolEntriesResponse) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "OuncedMessage_GetMempoolEntriesResponse is nil")
	}
	return x.GetMempoolEntriesResponse.toAppMessage()
}

func (x *OuncedMessage_GetMempoolEntriesResponse) fromAppMessage(message *appmessage.GetMempoolEntriesResponseMessage) error {
	var rpcErr *RPCError
