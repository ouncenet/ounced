...
func (x *OuncedMessage_TrustedData) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "OuncedMessage_TrustedDataMessage is nil")
	}
...
func (x *OuncedMessage_TrustedData) fromAppMessage(msgTrustedData *appmessage.MsgTrustedData) error {
