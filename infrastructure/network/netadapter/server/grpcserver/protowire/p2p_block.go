...
func (x *OuncedMessage_Block) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrap(errorNil, "OuncedMessage_Block is nil")
	}
	return x.Block.toAppMessage()
}

func (x *OuncedMessage_Block) fromAppMessage(msgBlock *appmessage.MsgBlock) error {
