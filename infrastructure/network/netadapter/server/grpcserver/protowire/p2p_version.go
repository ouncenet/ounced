...
func (x *OuncedMessage_Version) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "OuncedMessage_Version is nil")
	}
...
func (x *OuncedMessage_Version) fromAppMessage(msgVersion *appmessage.MsgVersion) error {
