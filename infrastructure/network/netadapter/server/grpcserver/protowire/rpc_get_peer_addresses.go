...
func (x *OuncedMessage_GetPeerAddressesRequest) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "OuncedMessage_GetPeerAddressesRequest is nil")
	}
	return &appmessage.GetPeerAddressesRequestMessage{}, nil
}

func (x *OuncedMessage_GetPeerAddressesRequest) fromAppMessage(_ *appmessage.GetPeerAddressesRequestMessage) error {
	return nil
}

func (x *OuncedMessage_GetPeerAddressesResponse) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "OuncedMessage_GetPeerAddressesResponse is nil")
	}
	return x.GetPeerAddressesResponse.toAppMessage()
}

func (x *OuncedMessage_GetPeerAddressesResponse) fromAppMessage(message *appmessage.GetPeerAddressesResponseMessage) error {
	var err *RPCError
