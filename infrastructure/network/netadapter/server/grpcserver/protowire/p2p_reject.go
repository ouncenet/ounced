...
func (x *OuncedMessage_Reject) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "OuncedMessage_Reject is nil")
	}
...
func (x *OuncedMessage_Reject) fromAppMessage(msgReject *appmessage.MsgReject) error {
