...
func (x *OuncedMessage_RequestHeaders) toAppMessage() (appmessage.Message, error) {
	if x == nil {
...
func (x *OuncedMessage_RequestHeaders) fromAppMessage(msgRequestHeaders *appmessage.MsgRequestHeaders) error {
