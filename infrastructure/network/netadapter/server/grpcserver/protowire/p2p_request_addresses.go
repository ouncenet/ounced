...
func (x *OuncedMessage_RequestAddresses) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "OuncedMessage_RequestAddresses is nil")
	}
...
func (x *RequestAddressesMessage) toAppMessage() (appmessage.Message, error) {
	...
	//  Full ounce nodes set SubnetworkId==nil
...
func (x *OuncedMessage_RequestAddresses) fromAppMessage(msgGetAddresses *appmessage.MsgRequestAddresses) error {
