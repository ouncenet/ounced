...
func (x *OuncedMessage_GetInfoRequest) toAppMessage() (appmessage.Message, error) {
	return &appmessage.GetInfoRequestMessage{}, nil
}

func (x *OuncedMessage_GetInfoRequest) fromAppMessage(_ *appmessage.GetInfoRequestMessage) error {
	x.GetInfoRequest = &GetInfoRequestMessage{}
	return nil
}

func (x *OuncedMessage_GetInfoResponse) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "OuncedMessage_GetInfoResponse is nil")
	}
	return x.GetInfoResponse.toAppMessage()
}

func (x *OuncedMessage_GetInfoResponse) fromAppMessage(message *appmessage.GetInfoResponseMessage) error {
	var err *RPCError
