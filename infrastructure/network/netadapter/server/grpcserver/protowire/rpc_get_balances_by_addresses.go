...
func (x *OuncedMessage_GetBalancesByAddressesRequest) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "OuncedMessage_GetBalanceByAddressRequest is nil")
	}
	return x.GetBalancesByAddressesRequest.toAppMessage()
}

func (x *OuncedMessage_GetBalancesByAddressesRequest) fromAppMessage(message *appmessage.GetBalancesByAddressesRequestMessage) error {
...
func (x *OuncedMessage_GetBalancesByAddressesResponse) toAppMessage() (appmessage.Message, error) {
	if x == nil {
...
func (x *OuncedMessage_GetBalancesByAddressesResponse) fromAppMessage(message *appmessage.GetBalancesByAddressesResponseMessage) error {
	var err *RPCError
