...
func (x *OuncedMessage_Transaction) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "OuncedMessage_Transaction is nil")
	}
	return x.Transaction.toAppMessage()
}

func (x *OuncedMessage_Transaction) fromAppMessage(msgTx *appmessage.MsgTx) error {
