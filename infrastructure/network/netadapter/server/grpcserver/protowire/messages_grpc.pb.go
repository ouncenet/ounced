...
type P2P_MessageStreamClient interface {
	Send(*OuncedMessage) error
	Recv() (*OuncedMessage, error)
	grpc.ClientStream
}
...
func (x *p2PMessageStreamClient) Send(m *OuncedMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *p2PMessageStreamClient) Recv() (*OuncedMessage, error) {
	m := new(OuncedMessage)
...
func (x *p2PMessageStreamServer) Send(m *OuncedMessage) error {
	return x.ServerStream.SendMsg(m)
}

func (x *p2PMessageStreamServer) Recv() (*OuncedMessage, error) {
	m := new(OuncedMessage)
...
func (x *rPCMessageStreamClient) Send(m *OuncedMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *rPCMessageStreamClient) Recv() (*OuncedMessage, error) {
	m := new(OuncedMessage)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (x *rPCMessageStreamServer) Send(m *OuncedMessage) error {
	return x.ServerStream.SendMsg(m)
}

func (x *rPCMessageStreamServer) Recv() (*OuncedMessage, error) {
	m := new(OuncedMessage)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
