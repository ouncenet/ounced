...
const miningAddress = "ouncedev:qrcqat6l9zcjsu7swnaztqzrv0s7hu04skpaezxk43y4etj8ncwfkuhy0zmax"
...
func runDAATest(t *testing.T, testName string, runDuration time.Duration,
	...
	tearDownKaspad := common.RunKaspadForTesting(t, "ounced-daa-test", rpcAddress)
