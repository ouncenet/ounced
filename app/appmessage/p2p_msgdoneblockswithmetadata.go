...
// MsgDoneBlocksWithTrustedData implements the Message interface and represents a ounce
...
// NewMsgDoneBlocksWithTrustedData returns a new ounce DoneBlocksWithTrustedData message that conforms to the
// Message interface.
