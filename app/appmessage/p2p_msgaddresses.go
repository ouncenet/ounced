...
// ounce Addresses message (MsgAddresses).
const MaxAddressesPerMsg = 1000

// MsgAddresses implements the Message interface and represents a ounce
// Addresses message.
...
// NewMsgAddresses returns a new ounce Addresses message that conforms to the
