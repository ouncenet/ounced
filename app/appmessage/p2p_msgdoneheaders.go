...
// MsgDoneHeaders implements the Message interface and represents a ounce
...
// NewMsgDoneHeaders returns a new ounce DoneIBDBlocks message that conforms to the
// Message interface.
