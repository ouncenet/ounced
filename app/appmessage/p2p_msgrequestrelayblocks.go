...
// MsgRequestRelayBlocks implements the Message interface and represents a ounce
...
// NewMsgRequestRelayBlocks returns a new ounce RequestRelayBlocks message that conforms to
