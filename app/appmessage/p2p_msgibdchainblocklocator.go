...
// MsgIBDChainBlockLocator implements the Message interface and represents a ounce
...
// NewMsgIBDChainBlockLocator returns a new ounce locator message that conforms to
