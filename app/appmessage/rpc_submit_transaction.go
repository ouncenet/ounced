...
// RPCTransaction is a ounced transaction representation meant to be
// used over RPC
...
// RPCTransactionInput is a ounced transaction input representation
...
// RPCScriptPublicKey is a ounced ScriptPublicKey representation
type RPCScriptPublicKey struct {
	Version uint16
	Script  string
}

// RPCTransactionOutput is a ounced transaction output representation
// meant to be used over RPC
...
// RPCOutpoint is a ounced outpoint representation meant to be used
// over RPC
...
// RPCUTXOEntry is a ounced utxo entry representation meant to be used
// over RPC
