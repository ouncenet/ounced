...
// MsgRequestHeaders implements the Message interface and represents a ounce
...
// NewMsgRequstHeaders returns a new ounce RequestHeaders message that conforms to the
