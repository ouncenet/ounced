...
// MsgRequestAddresses implements the Message interface and represents a ounce
...
// NewMsgRequestAddresses returns a new ounce RequestAddresses message that conforms to the
