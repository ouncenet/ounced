...
// MsgTransactionNotFound defines a ounce TransactionNotFound message which is sent in response to
...
// NewMsgTransactionNotFound returns a new ounce transactionsnotfound message that conforms to the
