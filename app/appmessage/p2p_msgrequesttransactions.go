...
// MsgRequestTransactions implements the Message interface and represents a ounce
...
// NewMsgRequestTransactions returns a new ounce RequestTransactions message that conforms to
