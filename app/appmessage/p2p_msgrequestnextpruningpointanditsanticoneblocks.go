...
// MsgRequestNextPruningPointAndItsAnticoneBlocks implements the Message interface and represents a ounce
...
// NewMsgRequestNextPruningPointAndItsAnticoneBlocks returns a new ounce RequestNextPruningPointAndItsAnticoneBlocks message that conforms to the
// Message interface.
