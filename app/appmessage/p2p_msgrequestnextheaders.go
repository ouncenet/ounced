...
// MsgRequestNextHeaders implements the Message interface and represents a ounce
...
// NewMsgRequestNextHeaders returns a new ounce RequestNextHeaders message that conforms to the
// Message interface.
