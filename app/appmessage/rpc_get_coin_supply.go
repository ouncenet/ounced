...
func NewGetCoinSupplyResponseMessage(maxGrain uint64, circulatingGrain uint64) *GetCoinSupplyResponseMessage {
	return &GetCoinSupplyResponseMessage{
		MaxGrain:         maxGrain,
		CirculatingGrain: circulatingGrain,
	}
}
