...
func main() {
	...
	if !cfg.AllowConnectionToDifferentVersions {
		kaspadMessage, err := client.Post(&protowire.OuncedMessage{Payload: &protowire.OuncedMessage_GetInfoRequest{GetInfoRequest: &protowire.GetInfoRequestMessage{}}})
		if err != nil {
...
func prettifyResponse(response string) string {
	kaspadMessage := &protowire.OuncedMessage{}
